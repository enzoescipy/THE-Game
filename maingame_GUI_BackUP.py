...
class MyApp(QWidget):
    ...
    def initUI(self):
        ...
        self.printt('주사위 마법사의 모험에 오신것을 환영합니다.',self)
        self.printt('작은 슬라임 이 전투를 걸어왔다!',self)
        self.printt('마법사의 붉은 피와 푸른 마나가 마력을 담은 주사위의 형상을 이루기 시작하였다.',self)
        self.printt('마법사의 두 눈은 상대의 체력과 기력/마나를 주사위의 형태로 파악해내기 시작하였다.',self)
        ...
        self.printt('전투 보상: 1 붉은 마력 주사위, 5 푸른 마력 주사위.',self)
        ...
        self.printt('',self)
        self.printt('강력한 스톤 골렘이 전투를 걸어왔다!',self)
